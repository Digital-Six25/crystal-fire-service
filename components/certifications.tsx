...
const certifications = [
  {
    ...
    description: "Crystal Fire Services is a proud member of the Fire Protection Association of Australia",
  },
  {
    logo: "/placeholder.svg?height=120&width=200",
    alt: "CM3 Contractor OHS/WHS Prequalification System",
    title: "CM3 Qualified",
    description: "Crystal Fire Services is fully qualified with CM3's Contractor OHS/WHS Prequalification system",
  },
  {
    logo: "/placeholder.svg?height=120&width=200",
    alt: "FMA Member 2017-2020 - Facility Management Association",
    title: "FMA Member",
    description: "Crystal Fire Services is a proud member of the Facility Management Association of Australia",
  },
  {
    logo: "/placeholder.svg?height=120&width=200",
    alt: "Property Council of Australia Member",
    title: "Property Council Member",
    description: "Crystal Fire Services is a proud member of the Property Council of Australia",
  },
]
            ...
            >
              <div className="mb-6 flex justify-center">
                <div className="relative w-48 h-24">
                  <Image src={cert.logo || "/placeholder.svg"} alt={cert.alt} fill className="object-contain" />
                </div>
              </div>
              <p className="text-gray-600 leading-relaxed max-w-md mx-auto">{cert.description}</p>
            </div>
          ))}
        </div>
        ...
        <div className="border-t border-gray-200 pt-16">
          ...
          >
            ...
            <p className="text-gray-600 leading-relaxed max-w-2xl mx-auto">
              Crystal Fire Services is ISO accredited in Quality Assurance, Environmental & Occupational Health & Safety
              Management Systems
            </p>
          </div>
        </div>
          ...
          {[
            ...
            >
              <div className="w-12 h-12 bg-teal-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-teal-600 font-bold text-xl">{item.icon}</span>
              </div>
